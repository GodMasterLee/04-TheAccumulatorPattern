...
def run_test_sum_more_cosines():
    ...
    # Test 2:
    expected = 0.33275  # This is APPROXIMATELY the correct answer.
    answer = sum_more_cosines(1, 8)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = -0.79513  # This is APPROXIMATELY the correct answer.
...
def run_test_count_sines_vs_cosines():
    ...
    # Test 6:
    expected = 88
    answer = count_sines_vs_cosines(88)
    print('Test 6 expected:', expected)
    print('       actual:  ', answer)
